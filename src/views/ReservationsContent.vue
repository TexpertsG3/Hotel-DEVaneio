...
<main class="container color-secondary font-size-regular">
      <section class="row pt-3 pb-3">
        ...
        <form
          action="#"
          id="form-reservations"
          class="row gap-2 j-space-between"
        >
              ...
              <label for="room-1" class="row j-space-between col-11-xl">
                ...
                <div class="col-8-xl">
                  ...
                  <p>
                    ...
                    Adipisci, magnam architecto. Quibusdam dicta dolor enim,
                    sint repudiandae ad excepturi accusantium.
                  </p>
                  <p>R$ 99,00</p>
                </div>
              </label>
          ...
          <div id="form__resume" class="row col-3-xl a-center gap-2">
            ...
            <div class="row col-12-xl gap-col gap-1 bg-grey-lighten-4 pd-1">
              <p class="col-12-xl">
                Apartamento: <span id="resume-room"></span>
              </p>
              <p class="col-12-xl">
                Checkin: <span id="resume-checkin"></span>
              </p>
              <p class="col-12-xl">
                Chekout: <span id="resume-checkout"></span>
              </p>
              <p class="col-12-xl">
