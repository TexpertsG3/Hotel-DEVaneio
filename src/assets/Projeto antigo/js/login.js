...
//   ) {
//     alert(
//       "Por favor, preencha adequadamente os campos solicitados.(Sem aspas e letras maiúsculas.)"
//     );
//     localStorage.clear();
//   } else if (
//     validateAccess(usuario, loginTemp) ||
//     validateAccess(mail, loginTemp)
//   ) {
//     alert(
//       "Desculpe, esse usuário já existe. Por favor, escolha outro, ou escolha logar ao lado."
//     );
//     localStorage.clear();
//   } else {
//     loginTemp.push(mail);
